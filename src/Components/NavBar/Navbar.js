    ...
    return (
        <>
            <nav className='navBar'>
                <i className="fa fa-bars" id='menushow' ></i>
                <i className="fa fa-close" id='menuhide' ></i>
                <h1><img src={Tryst} id='Tryst-logo' alt='Tryst'></img></h1>
                <text className='RightNav'>
                    <ul className='links' id='links'>
                        <li id='HomeLi'><NavLink to='' style={{ textDecoration: 'none' }}>Home</NavLink></li>
                        <li><NavLink to='/About' style={{ textDecoration: 'none' }}>About</NavLink></li>
                        <li><NavLink to='/CAP' style={{ textDecoration: 'none' }}>CAP</NavLink></li>
                        <li><NavLink to='/Accomodation' style={{ textDecoration: 'none' }}>Accomodation</NavLink></li>
                        <li><NavLink to='/Events' style={{ textDecoration: 'none' }}>Events</NavLink></li>
                        <li><NavLink to='/Speakers' style={{ textDecoration: 'none' }}>Speakers</NavLink></li>
                        <li><NavLink to='/Pronites' style={{ textDecoration: 'none' }}>Pronites</NavLink></li>
                        <li><NavLink to='/Sponsors' style={{ textDecoration: 'none' }}>Sponsors</NavLink></li>
                        <li><NavLink to='/ContactUs' style={{ textDecoration: 'none' }}>Contact Us</NavLink></li>
                    </ul>
